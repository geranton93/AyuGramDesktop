...
# Expects: -Droot_pem= -Drc_config_public_pem= -Dmanifest= -Dmanifest_sig= -Doutput=
# Embeds the four files from Resources/update/ verbatim: the manifests
...
append_array(kRcConfigPublicKeyPem ${rc_config_public_pem})
